...
function OrderSuccessContent() {
  ...
  return (
    <div className="container-x py-16 md:py-24 text-center max-w-lg mx-auto">
      ...
      {method === "COD" && (
        <div className="text-sm text-left bg-amber-50 border border-amber-200 px-5 py-4 mb-8">
          <p className="text-charcoal/70">
            Please keep the full order amount ready in cash at the time of
            delivery.
          </p>
        </div>
      )}
