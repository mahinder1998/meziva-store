...
export const metadata = {
  title: "Refund & Return Policy — Meziva Beauty",
};

export default function RefundPolicyPage() {
  return (
    <LegalPageLayout title="Refund & Return Policy" updatedDate="July 2026">
      <section>
        <h2>Return Window</h2>
        <p>
      ...
      <section>
        ...
        <p>
          Email <a href="mailto:support@meziva.in">support@meziva.in</a>{" "}
