...
console.log("DEBUG - Password length:", process.env.SHIPROCKET_PASSWORD?.length);
console.log("DEBUG - First 2 chars:", process.env.SHIPROCKET_PASSWORD?.slice(0, 2));
console.log("DEBUG - Last 2 chars:", process.env.SHIPROCKET_PASSWORD?.slice(-2));
