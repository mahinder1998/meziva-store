...
export default function Footer() {
  return (
    <footer className="bg-charcoal text-white">
      <div className="container-x py-16 md:py-20 grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr] gap-12 md:gap-10">
        <div>
          <h3 className="font-serif text-2xl tracking-wide mb-4">meziva</h3>
          <p className="text-sm text-white/60 leading-relaxed max-w-[280px]">
            Hydrating lip care crafted with real fruit extracts, Vitamin E,
            and SPF 30 — for lips that feel as good as they look.
          </p>
        ...
        <div>
          <h4 className="text-xs font-medium uppercase tracking-widest2 mb-5 text-white/50">
            Policies
          </h4>
      ...
      <div className="border-t border-white/10 py-6 text-center text-xs text-white/40 tracking-wide">
