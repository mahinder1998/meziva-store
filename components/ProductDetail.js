...
export default function ProductDetail({ product, relatedProducts = [], reviews }) {
  ...
  return (
    <>
      <div className="container-x py-8 md:py-12 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
        {/* Gallery */}
        <div>
          <div className="relative w-full aspect-[4/4] bg-white mb-4 border border-charcoal/10">
            <Image
          ...
          <div className="flex gap-3">
            {product.images.map((img, i) => (
              <button
                ...
                className={`relative w-20 h-24 border transition-colors duration-200 ${
        ...
        <div className="md:pt-4">
          ...
          <h1 className="font-serif text-3xl md:text-4xl text-charcoal mt-3 leading-tight">
            {product.name}
          </h1>
          ...
          <p className="text-sm text-charcoal/70 leading-7 mt-6 max-w-md">
            {product.description}
          </p>
          ...
          <div className="mt-8">
            ...
            <div className="inline-flex items-center border border-charcoal/20">
              <button
                className="w-11 h-11 text-charcoal/70 hover:text-charcoal transition-colors"
          ...
          <div className="grid grid-cols-2 gap-3 mt-10 md:pb-0">
            <div className="flex items-start gap-3 border border-charcoal/10 p-4">
              <div className="w-9 h-9 rounded-full border border-charcoal/15 flex items-center justify-center shrink-0">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-charcoal">
              ...
              <p className="text-xs sm:text-sm text-charcoal/70 leading-snug pt-1.5">
